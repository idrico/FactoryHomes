 ...
 * 
 */
@WebService(name = "InventorySystemServiceImpl", targetNamespace = "InventorySystem")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface InventorySystemService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "findCategoriesByHouseStyle", targetNamespace = "InventorySystem", className = "inventorysystem.findCategoriesByHouseStyle")
    @ResponseWrapper(localName = "findCategoriesByHouseStyleResponse", targetNamespace = "InventorySystem", className = "inventorysystem.findCategoriesByHouseStyleResponse")
    public List<Category> findCategoriesByHouseStyle();
